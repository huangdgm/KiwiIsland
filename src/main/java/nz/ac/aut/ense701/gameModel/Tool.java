...
public class Tool extends Item 
{
     ...
     * @param wikiDescription an article describing the tool
     */
    public Tool(Position pos, String name, String description, double weight, double size, String wikiDescription) 
    {
