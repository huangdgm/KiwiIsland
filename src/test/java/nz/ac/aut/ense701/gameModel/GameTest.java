...
public class GameTest extends junit.framework.TestCase {
     ...
     */
    /**
     * Tests for Accessor methods of Game, excluding those which are wrappers
     * for accessors in other classes. Other class accessors are tested in their
     * test classes.
     */
    @Test
    ...
    public void testCanScanWikiDescriptionFromIslandDataFile() {
        ...
        // The string format used be displayed in the pop up window
